...
namespace wallet_beautifier.crypto.algorithms.bech32
{
    ///<summary>
    /// Copied from https://github.com/tigrpoolcom/CardanoBech32Wrapper/blob/master/CardanoBech32/CardanoBech32Wrapper.cs
    ///
    /// Modified.
    ///</summary>
  public class CardanoBech32Wrapper
  {
    ...
    public string ConvertToBech32AddressFromBytes(byte[] inBytes, AddressType addressType)
    {
      var bech32Address = Bech32Engine.Encode(addressType.ToString(), inBytes);
